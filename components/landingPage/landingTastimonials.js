      ...
      <LandingContainer>
        ...
        <div className="md:columns-2 lg:columns-3 gap-8 space-y-8">
          <div
           ...
           bg-gray-800 border-gray-700 shadow-gray-600/10 shadow-none"
          >
            <div className="flex gap-4">
              ...
              />
              <div>
                <h6 className="text-lg font-medium text-white">Daniella Doe</h6>
          ...
          >
            <div className="flex gap-4">
              ...
              />
              <div>
                <h6 className="text-lg font-medium text-white">Jane doe</h6>
          ...
          >
            <div className="flex gap-4">
              ...
              />
              <div>
                <h6 className="text-lg font-medium text-white">Yanick Doe</h6>
          ...
          >
            <div className="flex gap-4">
              ...
              />
              <div>
                <h6 className="text-lg font-medium text-white">Andy Doe</h6>
          ...
          <div
            className="aspect-auto p-8 border rounded-3xl 
           bg-gray-800 border-gray-700  shadow-gray-600/10 
           shadow-none"
          >
            <div className="flex gap-4">
              <Image
              ...
              />
              <div>
                <h6 className="text-lg font-medium text-white">Yanndy Doe</h6>
                <p className="text-sm text-gray-300">Mobile dev</p>
              </div>
            </div>
            <p className="mt-8">
...
export default LandingTastimonials;
